  ...
  const icons: Record<string, ReactNode> = {
    ...
    "lead-nurturing": (
      <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
        ...
        <path d="M7.5 9h9M7.5 12.5h6" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" opacity=".7" />
      </svg>
    ),
    "reporting-dashboard": (
      <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
        <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" strokeWidth="1.6" />
        <path d="M7 16v-4M12 16V8M17 16v-7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
  };
      ...
      <SectionHeading
        ...
        title={
          <>
            ...
            <span className="text-gradient">We Build The System That Books Appointments.</span>
          </>
        }
        subtitle="Netlink combines lead generation, landing pages, automation, CRM workflows, and appointment setting into one managed growth system."
      />
